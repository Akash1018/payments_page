...
import SubscriptionPlan from '../SubscriptionPlan/subsPlan'
import pic from '../../static/Razorpay.png'
import './subs.css'
import { monthPlansList } from '../../data'
        ...
        <div className="subscription-container">
            ...
            <div className='discount'>
                ...
                <div className="subscription-fee-container">
                    <p className="signup">Subscription Fee</p>
            ...
            <img src= {pic} alt='limited time' className='razor-icon' />
        </div>
    )
}
